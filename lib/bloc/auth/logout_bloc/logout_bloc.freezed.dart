...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String uuid)?  logout,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _Logout() when logout != null:
return logout(_that.uuid);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String uuid)  logout,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String uuid)?  logout,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _Logout() when logout != null:
return logout(_that.uuid);case _:
...
class _Logout implements LogoutEvent {
  const _Logout({required this.uuid});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Logout&&(identical(other.uuid, uuid) || other.uuid == uuid));
}
...
@override
String toString() {
  return 'LogoutEvent.logout(uuid: $uuid)';
}
