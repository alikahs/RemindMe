...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String email,  String uuid,  String nama,  String token)?  login,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _Login() when login != null:
return login(_that.email,_that.uuid,_that.nama,_that.token);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String email,  String uuid,  String nama,  String token)  login,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String email,  String uuid,  String nama,  String token)?  login,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _Login() when login != null:
return login(_that.email,_that.uuid,_that.nama,_that.token);case _:
...
class _Login implements LoginEvent {
  const _Login({required this.email, required this.uuid, required this.nama, required this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Login&&(identical(other.email, email) || other.email == email)&&(identical(other.uuid, uuid) || other.uuid == uuid)&&(identical(other.nama, nama) || other.nama == nama)&&(identical(other.token, token) || other.token == token));
}


@override
int get hashCode => Object.hash(runtimeType,email,uuid,nama,token);

@override
String toString() {
  return 'LoginEvent.login(email: $email, uuid: $uuid, nama: $nama, token: $token)';
}
...
@useResult
$Res call({
 String email, String uuid, String nama, String token
});
...
/// Create a copy of LoginEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? email = null,Object? uuid = null,Object? nama = null,Object? token = null,}) {
  return _then(_Login(
